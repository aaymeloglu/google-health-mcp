...
inventory for data types this package exercises. Google Health API v4 continues
to evolve, so real-account testers should compare this inventory with the
official docs and release notes before filing coverage gaps.
